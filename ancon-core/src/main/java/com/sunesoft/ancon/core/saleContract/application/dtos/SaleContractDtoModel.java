 ...
 */
public class SaleContractDtoModel {
    ...
    private String contract_is_return;//合同是否已返回

    public String getContract_is_return() {
        return contract_is_return;
    }

    public void setContract_is_return(String contract_is_return) {
        this.contract_is_return = contract_is_return;
    }
